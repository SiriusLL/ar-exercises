...
s_name = gets.chomp
# store5 = Store.create(name: s_name, annual_revenue: 430000, mens_apparel: true, womens_apparel: true)
store7 = Store.create(name: s_name)
# store7.errors.size
puts store7.errors.full_messages.to_sentence